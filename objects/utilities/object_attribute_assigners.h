...
#ifndef SIMULATION_PROGRAM_OBJECT_ATTRIBUTE_ASSIGNERS_H
#define SIMULATION_PROGRAM_OBJECT_ATTRIBUTE_ASSIGNERS_H
...
#endif //SIMULATION_PROGRAM_OBJECT_ATTRIBUTE_ASSIGNERS_H